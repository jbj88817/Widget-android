...
public class WidgetProvider extends AppWidgetProvider {
    public static final String KEY_ITEM = "us.bojie.listwidget.KEY_ITEM";
    public static final String TOAST_ACTION = "us.bojie.listwidget.TOAST_ACTION";
